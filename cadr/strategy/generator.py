...
def generate_strategy(
    ...
    # Formulate rules
    entry_rule = f"{best_signal.asset_a}/{best_signal.asset_b} spread z-score magnitude >= {cfg.Z_SCORE_ENTRY_THRESHOLD}"
    exit_rule = f"Spread z-score magnitude <= {cfg.Z_SCORE_EXIT_THRESHOLD}"
    sl_rule = f"Spread z-score magnitude >= {cfg.Z_SCORE_STOP_THRESHOLD} OR {sl_pct*100:.1f}% position loss"
