const TRANSLATIONS = {
  en: {
    ...
    healthySignals: "Signals Without Scan Errors",
    ...
    healthySignalsNote: "Current watchlist pairs whose latest scan completed without execution or data errors.",
  ...
  ru: {
    ...
    healthySignals: "Сигналы без ошибок скана",
    ...
    healthySignalsNote: "Пары из текущего watchlist, по которым последний скан завершился без ошибок выполнения или данных.",
